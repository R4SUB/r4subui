...
# The tour uses the whole ecosystem, including the suggested r4subrisk and
# r4subdata. Only evaluate the code chunks when every piece is available so the
# vignette still renders where a suggested package is not installed.
have_pkgs <- all(vapply(
  c("r4subcore", "r4subscore", "r4subrisk", "r4subtrace",
    "r4subprofile", "r4subdata"),
...
# Restore the graphics parameters saved at the start of the tour.
par(oldpar)
```
